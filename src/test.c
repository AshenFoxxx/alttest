...
int main() {
    ...
    // 🔢 БАЗОВЫЕ ТЕСТЫ rpmvercmp
    printf("1️⃣ Basic rpmvercmp Tests\n");
    printf("------------------------\n");
    ...
    // 🔢 ЧИСЛОВЫЕ ТЕСТЫ (критические для RPM!)
    printf("2️⃣ Numeric Edge Cases\n");
    printf("----------------------\n");
    ...
    // 🔤 НЕЧИСЛОВЫЕ ТОКЕНЫ (rc, alpha, beta, fc)
    printf("4️⃣ Non-numeric Tokens\n");
    printf("-----------------------\n");
    ...
    // 🐛 КРАЕВЫЕ СЛУЧАИ (пустые строки, NULL, странные символы)
    printf("6️⃣ Edge Cases\n");
    printf("--------------\n");
